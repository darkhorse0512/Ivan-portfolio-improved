    ...
    >
      <div className="pr-10">
        ...
        >
          ...
          <br />
          <OpacityTextReveal>{about.description4}</OpacityTextReveal>
          <br />
          <OpacityTextReveal>{about.description5}</OpacityTextReveal>
        </Transition>
        <div className="pt-5">
        ...
        <div className="sticky ">
          <Transition>
            <Image
              ...
              height={480}
              alt={about.name}
              className="rounded-xl max-md:aspect-square cover pt-[20px]"
            />
          </Transition>
        </div>
      </div>
